...
**Osaka** هو مشروع واجهة أمامية (Front-End) تم تطويره باستخدام **HTML**, **CSS**, و**Bootstrap**. المشروع عبارة عن قالب شخصي (Portfolio Template) يعرض معلومات عن شخص ومهاراته وخدماته بطريقة جذابة وحديثة.
